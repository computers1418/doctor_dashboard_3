            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage("assets/images/${active=="sms" ? "left": "right"}-bg.png"), fit: BoxFit.fill)
                    ),
                    child: Column(
                      children: [
                        Row(
                          children: [
                            Expanded(child: GestureDetector(
                              ...
                              child: TabItem(type: "sms", count: "486", isSelected: active=="sms"))),
                            Expanded(child: GestureDetector(
                              onTap: (){
                                setState(() {
                                  active="voice";
                              ...
                              child: TabItem(type: "voice-call", count: "238", isSelected: active=="voice")))
                          ],
                        ),
                        Expanded(
                          child: ListView.separated(
                            itemCount: active=="sms" ? smsHistory.length: voiceHistory.length,
                            itemBuilder: (_, idx){
                              if(active=="voice"){
