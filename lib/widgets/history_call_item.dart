...
class HistoryCallItem extends StatelessWidget {
  ...
  const HistoryCallItem({super.key, required this.name, required this.phone, required this.time, required this.image, required this.received});
            ...
            children: [
              GestureDetector(
                ...
                child: CircleAvatar(
                  ...
                  child: Image.asset("assets/images/${received ? 'check-white': 'close'}.png", width: 13, height: 13)
                ),
              ),
              const SizedBox(height: 4),
              Text(received ? "Voice Call\nReceived": "Voice Call Not\nReceived",
