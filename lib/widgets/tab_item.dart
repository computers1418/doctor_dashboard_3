...
class TabItem extends StatelessWidget {
  ...
  const TabItem({super.key, required this.type, required this.count, required this.isSelected});
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Image.asset( "assets/images/${type=="sms" ? "sms": "voice-call"}${isSelected ? "-color-grad": ""}.png", width: 16, height: 16),
          ),
