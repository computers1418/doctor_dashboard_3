...
class HistorySmsItem extends StatelessWidget {
  ...
  const HistorySmsItem({super.key, required this.name, required this.phone, required this.time, required this.image});
            ...
            children: [
              GestureDetector(
                ...
                child: CircleAvatar(
                  ...
                  child: Image.asset("assets/images/check-white.png", width: 13, height: 13)
                ),
              ),
